<template>
  <div
    class="fixed right-2 top-[20%] z-50 flex -translate-y-1/3 transform flex-col md:right-3 lg:right-4 border border-primary-200 rounded-full bg-white/95 backdrop-blur-sm shadow-lg divide-y divide-primary-100"
  >
    <!-- LINE Contact Button -->
