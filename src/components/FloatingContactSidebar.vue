<template>
  <div
    class="fixed right-2 top-[300px] z-50 flex -translate-y-1/3 transform flex-col md:right-3 lg:right-4 border border-primary-200 rounded-full bg-white/95 backdrop-blur-sm shadow-lg divide-y divide-primary-100"
  >
    <!-- LINE Contact Button -->
    <div v-if="companySetting.line_link" class="p-2 md:p-2 lg:p-2 first:rounded-t-full">
      <a
    ...
    <div v-if="companySetting.whatsapp_link" class="p-2 md:p-2 lg:p-2">
      <a
    ...
    <div v-if="companySetting.phone_1" class="p-2 md:p-2 lg:p-2 last:rounded-b-full">
      <a
